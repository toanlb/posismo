...
jQuery.fn.datetime = function() {
	...
	var userLang 		= arguments[0]['userLang'] || 'jp';
	...
	return this.each(function(){
				...
				function renderPickerPlug(b24Hour_,lang_) {
					...
					var loadedLang = lang[lang_] || lang['jp'];
	 ...
	 // Slider
						$('#hourSlider').slider({
							...
							change: function(event, ui) {
								$('#tpSelectedTime .selHrs').effect('highlight', -1);
							}
						});
						// Slider
						$('#minuteSlider').slider({
							...
							change: function(event, ui) {
								$('#tpSelectedTime .selMins').effect('highlight', -1);
							}
						});
